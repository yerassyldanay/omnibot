...
EXCEPTION: dict = {
    KAZ: 'Сорри, қате шықты. Бірақ менен емес)',
...
EXAMPLES = [
    {
        KAZ: 'Кездесетін қызыма туған күніне қандай сыйлық сыйласам болады? Креативті ойлар айт.',
        RUS: 'Что подарить девушке на день рождения? Придумывайте креативные идеи.'
    },
    {
        KAZ: 'Кванттық физиканы оңай түсіндіріп бер. Мені бастауыш сынып оқушысы деп ойла. Барынша қысқа етіп жаз.',
        RUS: 'Объясните квантовую физику легко. Считайте меня учеником начальной школы. Пишите как можно короче.'
    },
    {
        KAZ: 'Мұхтар Әуезовтың Абай Жолы романына рецензия жазып бер. Қысқа етіп жаз.',
        RUS: 'Напишите рецензию на роман Мухтара Ауэзова «Путь Абая». Держать его коротким.'
    },
    {
        KAZ: 'Қазақстанға шетелден туристерді шақыратын видео-роликке текст жазып бер. Қазақстанның ерекше тұстарына жарнама болу керек.',
        RUS: 'Напишите текст для видеоролика, приглашающего иностранных туристов в Казахстан. Должна быть реклама про особенностей Казахстана.'
    },
    {
        KAZ: 'Хәрри Поттер стилінде өте қысқа әңгіме жазып бер.',
        RUS: 'Напишите очень короткий рассказ в стиле Гарри Поттер.'
    },
    {
        KAZ: 'Ағылшын тілін онлайн оқыту платформасы үшін ақпараттық және әзіл мазмұнында әлеуметтік желілерге жарнама жазыңыз. Мұны жастар стилінде жасаңыз, өйткені менің клиенттерім жастардан тұрады. Қысқа етіп жазыңыз.',
        RUS: 'Напишите рекламу в социальных сетях с информативным и юмористическим содержанием для онлайн-платформы для изучения английского языка. Делайте это в молодежном стиле, потому что мои клиенты — молодые люди. Держать его коротким.'
    },
    {
        KAZ: 'Таудың басында отырып, алысқа қарап тұрған суретімнің астына Instagram пост жазу керек. Оны философиялық етіп жасаңыз.',
        RUS: 'Напишите пост в Instagram под фотографией, на которой я сижу на вершине горы и смотрю вдаль. Сделайте это философским.'
    },
]
